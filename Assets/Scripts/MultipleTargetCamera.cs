...
public class MultipleTargetCamera : MonoBehaviour
{
    ...
    private float minCameraY = 20f;
    private float maxCameraY = 100f;
    private float maxCameraX = 100f;
    private float minCameraX = -100f;
    ...
    void Start() {
        ...
        cameraOffset = transform.position - GetCenterPoint();
    }
    void LateUpdate() {
        MoveCamera();
        ZoomCamera();
